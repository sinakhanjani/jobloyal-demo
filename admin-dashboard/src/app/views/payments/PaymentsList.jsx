...
const fetchData = async (pagination) => {
    const response = await axios.post("/payments/report", pagination);
...
const UsersList = (props) => {
    ...
    useEffect(() => {
        if (search.hasOwnProperty("text") && search.text.length > 1) {
            ...
            setSearching(true);
            axios.post("/payments/search", {page: page, limit: rowsPerPage, s: search.text}).then(result => {
            ...
            <Table className="whitespace-pre">
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell className="px-0">Total Amount</TableCell>
                        <TableCell className="px-0">Payable Amount</TableCell>
                                ...
                                <>
                                    <TableRow key={index} style={{display: 'content'}}>
                                        <TableCell className="px-0 capitalize" align="left">
                                            <Link to={`/dashboard/request/${subscriber.request_id}`}
