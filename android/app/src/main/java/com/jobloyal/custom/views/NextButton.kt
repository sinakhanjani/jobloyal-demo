...
class NextButton @JvmOverloads constructor(
    ...
    override fun setEnabled(enabled: Boolean) {
        ...
        if (enabled) {
            ...
            delegate.setBackgroundColor(ContextCompat.getColor(context,R.color.disabled_button_background))
        }
    }
    ...
    fun setWaiting (waiting : Boolean = false) {
        isEnabled = !waiting
        displayedChild = if (waiting) {
            1
        } else {
            0
        }
