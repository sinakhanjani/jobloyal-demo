...
class EmptyJobberListInboxView: UIView {
    
    let inboxImageView: UIImageView = {
        let imageView = UIImageView(image: UIImage(systemName: "rectangle.stack.person.crop")!)
    ...
    let titleLabel: UILabel = {
        ...
        label.text = "There is no jobber available right now".localized()
